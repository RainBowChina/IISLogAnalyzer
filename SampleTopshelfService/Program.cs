...
namespace SampleTopshelfService
{
    ...
    class Program
    {
            ...
            return (int)HostFactory.Run(x =>
                {
                    ...
                    x.Service(settings => new SampleService(throwOnStart, throwOnStop, throwUnhandled, new Uri("http://127.0.0.1:1234")));
        ...
        void SansInterface()
        {
            HostFactory.New(x => x.Service<SampleSansInterfaceService>(s =>
            {
